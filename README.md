...
- Approximate AI assistance in this assessment: 20%.
- AI was used mainly for:
	- drafting/refining `utils/websocket_client.py` connection, cleanup, and environment-variable loading flow.
	- drafting and formatting `README.md`.
- Test design choices, final assertions, and final code review decisions were made manually.
